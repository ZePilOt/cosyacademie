...
init python:
    credits = ('Personnages', 'din'), ('Backgrounds', 'Ze_PilOt'), ('Les Cheerleaders', 'Écrit par Clornide'), ('Le club Comédie', 'Écrit par Dieuvomi'),('Le club Comédie', 'Spectacle de Foulk : Twitter @Foulk32'), ('Le club Tech', 'Écrit par Decade'), ('Le club Otaku', 'Écrit par din'), ('Le club des Jeux', 'Écrit par Clornide'), ('Le club Rando', 'Écrit par Von Yaourt'), ('Le club de Bagarre', 'Écrit par KupowY'), ('Le conseil des élèves', 'Écrit par Decade'), ('Le Cosy Culture Club', 'Écrit par Ze_PilOt'), ('Le Verdict', 'Écrit par Clornide'), ('Relecture et corrections', 'KupowY'), ('Relecture et corrections', 'Samaël'),('Relecture et corrections', 'Von Yaourt'), ('Programmation', 'Ze_PilOt'), ('Mise en scène', 'Ze_PilOt'), ('Musique (Creative Common)', 'Scott Buckley'), ('Musique (Creative Common)', 'Myuu'), ('Musique (Creative Common)', 'KODOMOi')
